...
# Checking the number of observations to confirm that outliers have been removed
```{r}
nrow(cleaned_data)
```
# Checking the summary statistics to confirm that the extreme values have been removed
```{r}
